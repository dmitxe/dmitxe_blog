...
var url_ajax = '/theme/js/jlike/models/ajax.php';
...
//alert(serviceURI);
execOd = this;
return jq.post(/*this.domenhref + 'js/jlike/ajax.php'*/ url_ajax,{curl:serviceURI,variant:'od',tpget:typeGet}, function(data){
	if (data!=0) {
...
//alert(serviceURI);
execGP = this;
return jq.post(/*this.domenhref + 'js/jlike/ajax.php'*/ url_ajax,{curl:serviceURI,variant:'gp',tpget:typeGet}, function(data){
	if (data!=0) {
