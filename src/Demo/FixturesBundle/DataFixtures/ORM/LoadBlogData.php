...
use SmartCore\Module\Blog\Entity\Category;
use SmartCore\Module\Blog\Entity\Tag;
...
class LoadBlogData extends ContainerAware implements FixtureInterface, OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $user = $em->getRepository('SmartCore\Bundle\FOSUserBundle\Entity\User')->findOneBy([], ['id' => 'ASC']);
